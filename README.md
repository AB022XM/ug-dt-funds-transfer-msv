...
To build the final jar and optimize the FundsTransferMsvc application for production, run:
...
Then navigate to [http://localhost:9086](http://localhost:9086) in your browser.
